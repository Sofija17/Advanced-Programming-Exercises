...
public class MapSortingTest {
    ...
    private static <T extends Comparable<T>, E extends Comparable<E>> SortedSet<Map.Entry<T, E>> entriesSortedByValues(Map<T, E> map) {
        Comparator<Map.Entry<T, E>> comparator = (o1, o2) -> {
